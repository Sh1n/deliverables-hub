...
// Notifications Pop-Up
	...
	jQuery.fn.updateFieldStatus = function() {
		...
		$(field).removeClass('correctbox');
		$(field).removeClass('errorbox');
		$(field).next('img').remove();
		$(field).nextAll('br').remove();
		$(field).nextAll('span.smltxt').remove();
...
// Rich text editor/WYSIWYG
 ...
 jQuery.fn.message = function(){
    ...
    $(field).html("<div class=\"status "+ status+"\">" + message + "</div>");
 }
